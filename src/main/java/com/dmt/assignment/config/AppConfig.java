...
public class AppConfig {
	...
	public ValidationRule lcAlphaNumberRule() {
		...
		return new PasswordValidationRuleRegex(alphaNumericRuleRegex, alphaNumericRuleName, alphaNumericMsg);
	}
    ...
    public ValidationRule lcAlphaRule() {
        ...
        return new PasswordValidationRuleRegex(alphaRuleRegex, alphaRuleName, alphaNumericMsg);
    }
    @Bean
    ...
    public ValidationRule lcNumberRule() {
        ...
        return new PasswordValidationRuleRegex(numericRuleRegex, numericRuleName, alphaNumericMsg);
    }
	...
	public ValidationRule lengthValidationRule() {
		...
		return new PasswordValidationRuleRegex(lengthRuleRegex, lengthRuleName, lengthErrorMsg);
	}
	...
	public ValidationRule charSequenceRule() {
		...
		return new PasswordValidationRuleRegex(charSequenceRuleRegex, charSequenceRuleName, charSequenceErrorMsg);
	}
